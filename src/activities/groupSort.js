import { validateGroupSort } from './activityValidator.js';
...
export function createGroupSort(activity) {
  return Object.freeze({
    ...
    validate: (levelNumber, selectedAnswer, justification = null) => {
      ...
      return validateGroupSort(selectedAnswer, level.correctAnswer, justification);
    },
  });
}
